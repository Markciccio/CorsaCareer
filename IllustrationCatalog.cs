...
public static class IllustrationCatalog
{
    ...
    private static readonly IReadOnlyDictionary<string, IllustrationInfo> Library = new Dictionary<string, IllustrationInfo>(StringComparer.OrdinalIgnoreCase)
    {
        ...
        , ["manga-monami-kart-local-victory-celebration.png"] = new("Monami vince al kartodromo", "manga, kart, Monami, vittoria, squadra, podio, circuito-locale, giappone, entusiasmo", "kart quattro tempi da gara; bandiera a scacchi", "Monami festeggia una vittoria locale assieme a un team piccolo. Per risultati P1, rivalità positiva, felicità contagiosa e premi che permettono di correre ancora.")
        , ["manga-nobu-sponsor-rejection-kart-budget-rain.png"] = new("Nobu e il no dello sponsor", "manga, kart, Nobu, sponsor, budget, rifiuto, pioggia, ufficio, rimorchio, crisi", "kart da gara usato su rimorchio", "Nobu esce da un contatto sponsor non andato a buon fine, con il kart e il rimorchio sullo sfondo. Per rifiuti, mancanza di budget, trattative e scelte fuori dalla pista.")
        ...
        , ["character-nobu-relieved-small-sponsor-kart-paddock.png"] = new("Nobu trova un piccolo spiraglio", "manga, ritratto-personaggio, Nobu, sponsor, kart, paddock, pioggia, sollievo, budget", "kart su rimorchio sullo sfondo", "Nobu riceve una risposta finalmente positiva, ma ancora fragile, accanto al paddock bagnato. Per piccoli sponsor, sollievo dopo un rifiuto, budget che torna a respirare e dialoghi di speranza cauta.")
        , ["manga-monami-formula4-suzuka-first-test-determined.png"] = new("Monami prima del test Formula 4", "manga, Monami, formula-minore, Formula-4, Suzuka, giappone, test, pioggia, determinazione, garage", "monoposto Formula 4 bianco-rossa a ruote scoperte; casco e attrezzatura box", "Monami si infila i guanti davanti alla sua prima Formula 4 in un box bagnato di Suzuka. Per esordi, timore trasformato in concentrazione, test tecnici e promozioni dalla gavetta.")
        ...
        , ["manga-nobu-osaka-kart-sponsor-autoparts-negotiation.png"] = new("Nobu propone il kart a Osaka", "manga, Nobu, sponsor, trattativa, kart, Osaka, giappone, ricambi, budget, rifiuto, speranza", "kart quattro tempi rosso-bianco; furgone trasporto kart; ricambi automobilistici", "Nobu presenta il progetto a un ricambista di Osaka sotto la pioggia, con il kart sullo sfondo. Per cercare micro-sponsor, spiegare i costi, ricevere un rifiuto o strappare un primo incontro.")
        ...
        , ["manga-kart-first-team-choice-rei-nobu-genji-paddock.png"] = new("La prima scelta di squadra", "manga, kart, scelta-team, Rei, Nobu, Genji, paddock, giappone, contratto, offerta, budget", "tre kart da gara di piccole squadre, uno per tenda; caschi e cavalletti", "Rei consegna una cartellina al rookie davanti a tre piccole squadre kart; Genji valuta e Nobu fa i conti. Per il primo bivio, offerte diverse, scelta del team e posto da pilota-cliente.")
        , ["manga-kart-first-race-riku-monami-first-corner.png"] = new("La prima gara: Riku contro il rookie", "manga, kart, prima-gara, Riku, Monami, rivale, primo-giro, pioggia, sorpasso, giappone", "kart quattro tempi rosso-bianco; kart nero-giallo del rivale; gruppo di kart sullo sfondo", "Il rookie e Riku Hayase entrano affiancati nella prima curva bagnata mentre Monami guarda dal muretto. Per il primo weekend, partenze difficili, rivalità e risultati che modificano fiducia e sponsor.")
        , ["manga-kart-first-sponsor-agreement-local-workshop.png"] = new("Il primo accordo con uno sponsor", "manga, kart, primo-sponsor, accordo, officina, budget, giappone, rookie, Genji, Nobu", "kart quattro tempi rosso-bianco; casco, ricambi e componenti officina", "Il rookie stringe la mano a un piccolo sponsor locale nell'officina, con Nobu e il kart alle spalle. Per un accordo iniziale, un budget minimo ma decisivo, e la prima prova che qualcuno crede nel progetto.")
